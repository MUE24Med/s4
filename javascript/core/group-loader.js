...
import { sendImagesToBack, bringRectsToFront, hideOverlappingGroupImages } from './layer-manager.js';
import { updateDynamicSizes } from './dynamic-size.js';
import { updateSectionName } from './section-name.js';
import { loadingProgress } from './loading-state.js'; // فقط للقراءة عند الحاجة
